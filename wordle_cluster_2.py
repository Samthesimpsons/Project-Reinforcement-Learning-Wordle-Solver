...
def reinforcement_learning(learning_rate: int, exploration_rate: int, shrinkage_factor: int, number_of_cluster: int, Q_table):
...
if __name__ == '__main__':
    ...
    for i in tqdm(range(training_epochs)):
        steps = reinforcement_learning(learning_rate=0.1, exploration_rate=0.1, shrinkage_factor=0.9, number_of_cluster=number_of_cluster, Q_table=Q_table) # run RL algorithm
        guesses[i] = steps
